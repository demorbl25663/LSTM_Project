-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_PRT_pred\hdlsrc\LSTM_cell\cell_gate.vhd
...
-- 
-- Module: cell_gate
-- Source Path: LSTM_cell/LSTM_predictor/LSTM_layers/lstm_cell_subsystem/cell_gate
-- Hierarchy Level: 3
-- Model version: 5.46
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF cell_gate IS
  ...
  FOR ALL : tanh
    USE ENTITY work.tanh(rtl);

  -- Signals
  SIGNAL In1_signed                       : vector_of_std_logic_vector16(0 TO 10);  -- ufix16 [11]
  SIGNAL c6_w_c_out1                      : vector_of_signed16(0 TO 109);  -- sfix16_En15 [110]
  SIGNAL w_c_out1                         : matrix_of_signed16(0 TO 9, 0 TO 10);  -- sfix16_En15 [10x11]
...
BEGIN
  ...
  c6_w_c_out1(0) <= to_signed(-16#01F2#, 16);
  c6_w_c_out1(1) <= to_signed(-16#1D88#, 16);
  c6_w_c_out1(2) <= to_signed(-16#4659#, 16);
  c6_w_c_out1(3) <= to_signed(16#4638#, 16);
  c6_w_c_out1(4) <= to_signed(-16#1A21#, 16);
  c6_w_c_out1(5) <= to_signed(16#1C0A#, 16);
  c6_w_c_out1(6) <= to_signed(-16#009C#, 16);
  c6_w_c_out1(7) <= to_signed(-16#2F75#, 16);
  c6_w_c_out1(8) <= to_signed(-16#022A#, 16);
  c6_w_c_out1(9) <= to_signed(16#0F6A#, 16);
  c6_w_c_out1(10) <= to_signed(16#4B18#, 16);
  c6_w_c_out1(11) <= to_signed(-16#13DC#, 16);
  c6_w_c_out1(12) <= to_signed(16#1187#, 16);
  c6_w_c_out1(13) <= to_signed(-16#0706#, 16);
  c6_w_c_out1(14) <= to_signed(16#3E28#, 16);
  c6_w_c_out1(15) <= to_signed(-16#2347#, 16);
  c6_w_c_out1(16) <= to_signed(-16#2CB1#, 16);
  c6_w_c_out1(17) <= to_signed(-16#0E75#, 16);
  c6_w_c_out1(18) <= to_signed(16#0999#, 16);
  c6_w_c_out1(19) <= to_signed(-16#3246#, 16);
  c6_w_c_out1(20) <= to_signed(16#2BC5#, 16);
  c6_w_c_out1(21) <= to_signed(-16#1A7B#, 16);
  c6_w_c_out1(22) <= to_signed(-16#14F6#, 16);
  c6_w_c_out1(23) <= to_signed(-16#00CA#, 16);
  c6_w_c_out1(24) <= to_signed(16#190F#, 16);
  c6_w_c_out1(25) <= to_signed(-16#09F6#, 16);
  c6_w_c_out1(26) <= to_signed(16#1666#, 16);
  c6_w_c_out1(27) <= to_signed(16#1156#, 16);
  c6_w_c_out1(28) <= to_signed(16#160D#, 16);
  c6_w_c_out1(29) <= to_signed(-16#149E#, 16);
  c6_w_c_out1(30) <= to_signed(-16#392E#, 16);
  c6_w_c_out1(31) <= to_signed(16#0F2E#, 16);
  c6_w_c_out1(32) <= to_signed(-16#3BAB#, 16);
  c6_w_c_out1(33) <= to_signed(16#2364#, 16);
  c6_w_c_out1(34) <= to_signed(-16#284A#, 16);
  c6_w_c_out1(35) <= to_signed(16#327E#, 16);
  c6_w_c_out1(36) <= to_signed(16#2081#, 16);
  c6_w_c_out1(37) <= to_signed(-16#1E16#, 16);
  c6_w_c_out1(38) <= to_signed(-16#17E4#, 16);
  c6_w_c_out1(39) <= to_signed(16#1089#, 16);
  c6_w_c_out1(40) <= to_signed(16#09CE#, 16);
  c6_w_c_out1(41) <= to_signed(-16#0512#, 16);
  c6_w_c_out1(42) <= to_signed(16#35CB#, 16);
  c6_w_c_out1(43) <= to_signed(-16#0E96#, 16);
  c6_w_c_out1(44) <= to_signed(16#1C52#, 16);
  c6_w_c_out1(45) <= to_signed(-16#3DE0#, 16);
  c6_w_c_out1(46) <= to_signed(-16#0D12#, 16);
  c6_w_c_out1(47) <= to_signed(16#1A45#, 16);
  c6_w_c_out1(48) <= to_signed(-16#1454#, 16);
  c6_w_c_out1(49) <= to_signed(-16#0410#, 16);
  c6_w_c_out1(50) <= to_signed(16#110F#, 16);
  c6_w_c_out1(51) <= to_signed(16#1444#, 16);
  c6_w_c_out1(52) <= to_signed(-16#04C2#, 16);
  c6_w_c_out1(53) <= to_signed(16#2108#, 16);
  c6_w_c_out1(54) <= to_signed(-16#0E8C#, 16);
  c6_w_c_out1(55) <= to_signed(16#0489#, 16);
  c6_w_c_out1(56) <= to_signed(16#0312#, 16);
  c6_w_c_out1(57) <= to_signed(16#0148#, 16);
  c6_w_c_out1(58) <= to_signed(-16#1496#, 16);
  c6_w_c_out1(59) <= to_signed(16#2740#, 16);
  c6_w_c_out1(60) <= to_signed(-16#10C2#, 16);
  c6_w_c_out1(61) <= to_signed(16#08CA#, 16);
  c6_w_c_out1(62) <= to_signed(16#0645#, 16);
  c6_w_c_out1(63) <= to_signed(16#012D#, 16);
  c6_w_c_out1(64) <= to_signed(16#21EF#, 16);
  c6_w_c_out1(65) <= to_signed(16#2328#, 16);
  c6_w_c_out1(66) <= to_signed(-16#23AB#, 16);
  c6_w_c_out1(67) <= to_signed(16#2C23#, 16);
  c6_w_c_out1(68) <= to_signed(16#0E0F#, 16);
  c6_w_c_out1(69) <= to_signed(16#19FB#, 16);
  c6_w_c_out1(70) <= to_signed(16#24D8#, 16);
  c6_w_c_out1(71) <= to_signed(16#105D#, 16);
  c6_w_c_out1(72) <= to_signed(16#40FA#, 16);
  c6_w_c_out1(73) <= to_signed(16#01A3#, 16);
  c6_w_c_out1(74) <= to_signed(16#0CD4#, 16);
  c6_w_c_out1(75) <= to_signed(-16#44C4#, 16);
  c6_w_c_out1(76) <= to_signed(-16#1CEF#, 16);
  c6_w_c_out1(77) <= to_signed(16#0B97#, 16);
  c6_w_c_out1(78) <= to_signed(-16#1027#, 16);
  c6_w_c_out1(79) <= to_signed(16#19F2#, 16);
  c6_w_c_out1(80) <= to_signed(-16#4BDA#, 16);
  c6_w_c_out1(81) <= to_signed(-16#10BF#, 16);
  c6_w_c_out1(82) <= to_signed(-16#4517#, 16);
  c6_w_c_out1(83) <= to_signed(16#354D#, 16);
  c6_w_c_out1(84) <= to_signed(-16#1D1A#, 16);
  c6_w_c_out1(85) <= to_signed(16#2265#, 16);
  c6_w_c_out1(86) <= to_signed(16#2E76#, 16);
  c6_w_c_out1(87) <= to_signed(16#0845#, 16);
  c6_w_c_out1(88) <= to_signed(16#0D6C#, 16);
  c6_w_c_out1(89) <= to_signed(16#289D#, 16);
  c6_w_c_out1(90) <= to_signed(-16#3289#, 16);
  c6_w_c_out1(91) <= to_signed(16#1375#, 16);
  c6_w_c_out1(92) <= to_signed(-16#40AB#, 16);
  c6_w_c_out1(93) <= to_signed(16#37F0#, 16);
  c6_w_c_out1(94) <= to_signed(-16#27A5#, 16);
  c6_w_c_out1(95) <= to_signed(16#34AC#, 16);
  c6_w_c_out1(96) <= to_signed(16#10E7#, 16);
  c6_w_c_out1(97) <= to_signed(16#19F1#, 16);
  c6_w_c_out1(98) <= to_signed(-16#0F3F#, 16);
  c6_w_c_out1(99) <= to_signed(-16#058E#, 16);
  c6_w_c_out1(100) <= to_signed(-16#0552#, 16);
  c6_w_c_out1(101) <= to_signed(-16#3049#, 16);
  c6_w_c_out1(102) <= to_signed(-16#1CCD#, 16);
  c6_w_c_out1(103) <= to_signed(16#2BBC#, 16);
  c6_w_c_out1(104) <= to_signed(-16#49FA#, 16);
  c6_w_c_out1(105) <= to_signed(16#14D9#, 16);
  c6_w_c_out1(106) <= to_signed(16#33A5#, 16);
  c6_w_c_out1(107) <= to_signed(-16#32BD#, 16);
  c6_w_c_out1(108) <= to_signed(16#4191#, 16);
  c6_w_c_out1(109) <= to_signed(16#524F#, 16);

  w_c_out1_gen1: FOR d1 IN 0 TO 10 GENERATE
    w_c_out1_gen: FOR d0 IN 0 TO 9 GENERATE
      w_c_out1(d0, d1) <= c6_w_c_out1(d0 + (d1 * 10));
    END GENERATE;
  END GENERATE;

  s_gen1: FOR d1 IN 0 TO 10 GENERATE
    s_gen: FOR d0 IN 0 TO 9 GENERATE
      s(d0 + (d1 * 10)) <= w_c_out1(d0, d1);
    END GENERATE;
  END GENERATE;
