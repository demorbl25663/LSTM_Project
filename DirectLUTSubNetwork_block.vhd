-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_PRT_pred\hdlsrc\LSTM_cell\DirectLUTSubNetwork_block.vhd
...
ENTITY DirectLUTSubNetwork_block IS
  PORT( Q1                                :   IN    vector_of_std_logic_vector5(0 TO 9);  -- ufix5 [10]
        fQ1                               :   OUT   vector_of_std_logic_vector16(0 TO 9)  -- sfix16_En15 [10]
        );
END DirectLUTSubNetwork_block;


ARCHITECTURE rtl OF DirectLUTSubNetwork_block IS
