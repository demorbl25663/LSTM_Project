-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_PRT_pred\hdlsrc\LSTM_cell\input_gate.vhd
...
-- 
-- Module: input_gate
-- Source Path: LSTM_cell/LSTM_predictor/LSTM_layers/lstm_cell_subsystem/input_gate
-- Hierarchy Level: 3
-- Model version: 5.46
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF input_gate IS
  ...
  FOR ALL : sig_block
    USE ENTITY work.sig_block(rtl);

  -- Signals
  SIGNAL In1_signed                       : vector_of_std_logic_vector16(0 TO 10);  -- ufix16 [11]
  SIGNAL c6_w_i_out1                      : vector_of_signed16(0 TO 109);  -- sfix16_En15 [110]
  SIGNAL w_i_out1                         : matrix_of_signed16(0 TO 9, 0 TO 10);  -- sfix16_En15 [10x11]
...
BEGIN
  ...
  c6_w_i_out1(0) <= to_signed(-16#148D#, 16);
  c6_w_i_out1(1) <= to_signed(-16#1C4A#, 16);
  c6_w_i_out1(2) <= to_signed(16#2B2C#, 16);
  c6_w_i_out1(3) <= to_signed(16#01F2#, 16);
  c6_w_i_out1(4) <= to_signed(16#3606#, 16);
  c6_w_i_out1(5) <= to_signed(16#094B#, 16);
  c6_w_i_out1(6) <= to_signed(16#4025#, 16);
  c6_w_i_out1(7) <= to_signed(16#1234#, 16);
  c6_w_i_out1(8) <= to_signed(16#0312#, 16);
  c6_w_i_out1(9) <= to_signed(16#3285#, 16);
  c6_w_i_out1(10) <= to_signed(-16#04B5#, 16);
  c6_w_i_out1(11) <= to_signed(-16#1967#, 16);
  c6_w_i_out1(12) <= to_signed(16#005C#, 16);
  c6_w_i_out1(13) <= to_signed(-16#2145#, 16);
  c6_w_i_out1(14) <= to_signed(-16#00D6#, 16);
  c6_w_i_out1(15) <= to_signed(-16#308A#, 16);
  c6_w_i_out1(16) <= to_signed(-16#16E4#, 16);
  c6_w_i_out1(17) <= to_signed(16#15AF#, 16);
  c6_w_i_out1(18) <= to_signed(-16#0266#, 16);
  c6_w_i_out1(19) <= to_signed(-16#05E2#, 16);
  c6_w_i_out1(20) <= to_signed(-16#22D5#, 16);
  c6_w_i_out1(21) <= to_signed(-16#161C#, 16);
  c6_w_i_out1(22) <= to_signed(16#26B9#, 16);
  c6_w_i_out1(23) <= to_signed(16#1ADF#, 16);
  c6_w_i_out1(24) <= to_signed(16#2B72#, 16);
  c6_w_i_out1(25) <= to_signed(-16#2D3A#, 16);
  c6_w_i_out1(26) <= to_signed(16#0291#, 16);
  c6_w_i_out1(27) <= to_signed(16#207B#, 16);
  c6_w_i_out1(28) <= to_signed(-16#012A#, 16);
  c6_w_i_out1(29) <= to_signed(16#1C63#, 16);
  c6_w_i_out1(30) <= to_signed(16#075E#, 16);
  c6_w_i_out1(31) <= to_signed(16#0402#, 16);
  c6_w_i_out1(32) <= to_signed(16#15E4#, 16);
  c6_w_i_out1(33) <= to_signed(16#21FF#, 16);
  c6_w_i_out1(34) <= to_signed(16#1328#, 16);
  c6_w_i_out1(35) <= to_signed(16#00CB#, 16);
  c6_w_i_out1(36) <= to_signed(-16#2433#, 16);
  c6_w_i_out1(37) <= to_signed(-16#05E9#, 16);
  c6_w_i_out1(38) <= to_signed(16#0073#, 16);
  c6_w_i_out1(39) <= to_signed(-16#0E10#, 16);
  c6_w_i_out1(40) <= to_signed(-16#29D9#, 16);
  c6_w_i_out1(41) <= to_signed(16#09BA#, 16);
  c6_w_i_out1(42) <= to_signed(-16#2FFA#, 16);
  c6_w_i_out1(43) <= to_signed(-16#18F7#, 16);
  c6_w_i_out1(44) <= to_signed(16#0EE4#, 16);
  c6_w_i_out1(45) <= to_signed(-16#017E#, 16);
  c6_w_i_out1(46) <= to_signed(-16#0DB5#, 16);
  c6_w_i_out1(47) <= to_signed(-16#20A9#, 16);
  c6_w_i_out1(48) <= to_signed(-16#0614#, 16);
  c6_w_i_out1(49) <= to_signed(16#35B0#, 16);
  c6_w_i_out1(50) <= to_signed(-16#0FED#, 16);
  c6_w_i_out1(51) <= to_signed(16#04B6#, 16);
  c6_w_i_out1(52) <= to_signed(16#1376#, 16);
  c6_w_i_out1(53) <= to_signed(-16#15ED#, 16);
  c6_w_i_out1(54) <= to_signed(-16#138A#, 16);
  c6_w_i_out1(55) <= to_signed(16#1B3A#, 16);
  c6_w_i_out1(56) <= to_signed(-16#2ADA#, 16);
  c6_w_i_out1(57) <= to_signed(-16#04DF#, 16);
  c6_w_i_out1(58) <= to_signed(-16#2945#, 16);
  c6_w_i_out1(59) <= to_signed(-16#387B#, 16);
  c6_w_i_out1(60) <= to_signed(16#019F#, 16);
  c6_w_i_out1(61) <= to_signed(16#19B8#, 16);
  c6_w_i_out1(62) <= to_signed(-16#0E78#, 16);
  c6_w_i_out1(63) <= to_signed(-16#09FD#, 16);
  c6_w_i_out1(64) <= to_signed(-16#36EB#, 16);
  c6_w_i_out1(65) <= to_signed(16#02DE#, 16);
  c6_w_i_out1(66) <= to_signed(-16#0593#, 16);
  c6_w_i_out1(67) <= to_signed(-16#2080#, 16);
  c6_w_i_out1(68) <= to_signed(16#0FE7#, 16);
  c6_w_i_out1(69) <= to_signed(-16#3A62#, 16);
  c6_w_i_out1(70) <= to_signed(-16#2224#, 16);
  c6_w_i_out1(71) <= to_signed(-16#0B33#, 16);
  c6_w_i_out1(72) <= to_signed(16#1B26#, 16);
  c6_w_i_out1(73) <= to_signed(-16#1B38#, 16);
  c6_w_i_out1(74) <= to_signed(-16#3411#, 16);
  c6_w_i_out1(75) <= to_signed(-16#20BE#, 16);
  c6_w_i_out1(76) <= to_signed(16#24ED#, 16);
  c6_w_i_out1(77) <= to_signed(-16#124F#, 16);
  c6_w_i_out1(78) <= to_signed(-16#0BBF#, 16);
  c6_w_i_out1(79) <= to_signed(16#3829#, 16);
  c6_w_i_out1(80) <= to_signed(-16#17BB#, 16);
  c6_w_i_out1(81) <= to_signed(16#3AE0#, 16);
  c6_w_i_out1(82) <= to_signed(-16#00AC#, 16);
  c6_w_i_out1(83) <= to_signed(16#16D0#, 16);
  c6_w_i_out1(84) <= to_signed(16#0A05#, 16);
  c6_w_i_out1(85) <= to_signed(16#2B4E#, 16);
  c6_w_i_out1(86) <= to_signed(-16#0A36#, 16);
  c6_w_i_out1(87) <= to_signed(16#0B8E#, 16);
  c6_w_i_out1(88) <= to_signed(16#34DC#, 16);
  c6_w_i_out1(89) <= to_signed(16#0195#, 16);
  c6_w_i_out1(90) <= to_signed(16#350D#, 16);
  c6_w_i_out1(91) <= to_signed(16#1CEE#, 16);
  c6_w_i_out1(92) <= to_signed(16#2EA0#, 16);
  c6_w_i_out1(93) <= to_signed(-16#127B#, 16);
  c6_w_i_out1(94) <= to_signed(16#18CD#, 16);
  c6_w_i_out1(95) <= to_signed(-16#0D78#, 16);
  c6_w_i_out1(96) <= to_signed(16#2E6E#, 16);
  c6_w_i_out1(97) <= to_signed(16#2492#, 16);
  c6_w_i_out1(98) <= to_signed(-16#0E33#, 16);
  c6_w_i_out1(99) <= to_signed(-16#32C7#, 16);
  c6_w_i_out1(100) <= to_signed(-16#0441#, 16);
  c6_w_i_out1(101) <= to_signed(16#1E1E#, 16);
  c6_w_i_out1(102) <= to_signed(16#2988#, 16);
  c6_w_i_out1(103) <= to_signed(16#2003#, 16);
  c6_w_i_out1(104) <= to_signed(16#0EFB#, 16);
  c6_w_i_out1(105) <= to_signed(-16#118E#, 16);
  c6_w_i_out1(106) <= to_signed(16#3F26#, 16);
  c6_w_i_out1(107) <= to_signed(16#30EA#, 16);
  c6_w_i_out1(108) <= to_signed(16#4DA0#, 16);
  c6_w_i_out1(109) <= to_signed(16#2EF7#, 16);

  w_i_out1_gen1: FOR d1 IN 0 TO 10 GENERATE
    w_i_out1_gen: FOR d0 IN 0 TO 9 GENERATE
      w_i_out1(d0, d1) <= c6_w_i_out1(d0 + (d1 * 10));
    END GENERATE;
  END GENERATE;

  s_gen1: FOR d1 IN 0 TO 10 GENERATE
    s_gen: FOR d0 IN 0 TO 9 GENERATE
      s(d0 + (d1 * 10)) <= w_i_out1(d0, d1);
    END GENERATE;
  END GENERATE;
