-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_PRT_pred\hdlsrc\LSTM_cell\output_gate.vhd
...
-- 
-- Module: output_gate
-- Source Path: LSTM_cell/LSTM_predictor/LSTM_layers/lstm_cell_subsystem/output_gate
-- Hierarchy Level: 3
-- Model version: 5.46
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF output_gate IS

  -- Component Declarations
  COMPONENT sig_block1
  ...
  FOR ALL : sig_block1
    USE ENTITY work.sig_block1(rtl);

  -- Signals
  SIGNAL In1_signed                       : vector_of_std_logic_vector16(0 TO 10);  -- ufix16 [11]
  SIGNAL c6_w_o_out1                      : vector_of_signed16(0 TO 109);  -- sfix16_En15 [110]
  SIGNAL w_o_out1                         : matrix_of_signed16(0 TO 9, 0 TO 10);  -- sfix16_En15 [10x11]
...
BEGIN
  ...
  c6_w_o_out1(0) <= to_signed(-16#2DA5#, 16);
  c6_w_o_out1(1) <= to_signed(16#1654#, 16);
  c6_w_o_out1(2) <= to_signed(16#1059#, 16);
  c6_w_o_out1(3) <= to_signed(16#43BA#, 16);
  c6_w_o_out1(4) <= to_signed(16#0CF9#, 16);
  c6_w_o_out1(5) <= to_signed(-16#12E2#, 16);
  c6_w_o_out1(6) <= to_signed(-16#009F#, 16);
  c6_w_o_out1(7) <= to_signed(16#101E#, 16);
  c6_w_o_out1(8) <= to_signed(16#25F7#, 16);
  c6_w_o_out1(9) <= to_signed(16#1B6D#, 16);
  c6_w_o_out1(10) <= to_signed(-16#3BB3#, 16);
  c6_w_o_out1(11) <= to_signed(-16#42AC#, 16);
  c6_w_o_out1(12) <= to_signed(-16#1DC3#, 16);
  c6_w_o_out1(13) <= to_signed(-16#0C90#, 16);
  c6_w_o_out1(14) <= to_signed(-16#301B#, 16);
  c6_w_o_out1(15) <= to_signed(-16#0965#, 16);
  c6_w_o_out1(16) <= to_signed(-16#3CA1#, 16);
  c6_w_o_out1(17) <= to_signed(-16#0CCF#, 16);
  c6_w_o_out1(18) <= to_signed(-16#0948#, 16);
  c6_w_o_out1(19) <= to_signed(-16#33B4#, 16);
  c6_w_o_out1(20) <= to_signed(-16#01C0#, 16);
  c6_w_o_out1(21) <= to_signed(-16#1817#, 16);
  c6_w_o_out1(22) <= to_signed(-16#144D#, 16);
  c6_w_o_out1(23) <= to_signed(-16#0C95#, 16);
  c6_w_o_out1(24) <= to_signed(-16#0167#, 16);
  c6_w_o_out1(25) <= to_signed(-16#20C9#, 16);
  c6_w_o_out1(26) <= to_signed(-16#1668#, 16);
  c6_w_o_out1(27) <= to_signed(16#1EEA#, 16);
  c6_w_o_out1(28) <= to_signed(16#13CC#, 16);
  c6_w_o_out1(29) <= to_signed(16#02D2#, 16);
  c6_w_o_out1(30) <= to_signed(16#2AAF#, 16);
  c6_w_o_out1(31) <= to_signed(16#113E#, 16);
  c6_w_o_out1(32) <= to_signed(-16#1B8C#, 16);
  c6_w_o_out1(33) <= to_signed(16#0A7A#, 16);
  c6_w_o_out1(34) <= to_signed(16#3417#, 16);
  c6_w_o_out1(35) <= to_signed(-16#035F#, 16);
  c6_w_o_out1(36) <= to_signed(16#0760#, 16);
  c6_w_o_out1(37) <= to_signed(16#1160#, 16);
  c6_w_o_out1(38) <= to_signed(16#3146#, 16);
  c6_w_o_out1(39) <= to_signed(-16#348A#, 16);
  c6_w_o_out1(40) <= to_signed(-16#05AC#, 16);
  c6_w_o_out1(41) <= to_signed(-16#0FD7#, 16);
  c6_w_o_out1(42) <= to_signed(-16#254E#, 16);
  c6_w_o_out1(43) <= to_signed(16#0311#, 16);
  c6_w_o_out1(44) <= to_signed(-16#1D8E#, 16);
  c6_w_o_out1(45) <= to_signed(16#1152#, 16);
  c6_w_o_out1(46) <= to_signed(-16#2240#, 16);
  c6_w_o_out1(47) <= to_signed(-16#28B2#, 16);
  c6_w_o_out1(48) <= to_signed(-16#370F#, 16);
  c6_w_o_out1(49) <= to_signed(16#1EAA#, 16);
  c6_w_o_out1(50) <= to_signed(16#0B7B#, 16);
  c6_w_o_out1(51) <= to_signed(16#17EB#, 16);
  c6_w_o_out1(52) <= to_signed(16#1CB2#, 16);
  c6_w_o_out1(53) <= to_signed(16#15B4#, 16);
  c6_w_o_out1(54) <= to_signed(-16#31A0#, 16);
  c6_w_o_out1(55) <= to_signed(-16#0B71#, 16);
  c6_w_o_out1(56) <= to_signed(16#05F9#, 16);
  c6_w_o_out1(57) <= to_signed(-16#1E3E#, 16);
  c6_w_o_out1(58) <= to_signed(-16#1DAD#, 16);
  c6_w_o_out1(59) <= to_signed(-16#1E85#, 16);
  c6_w_o_out1(60) <= to_signed(16#1EE7#, 16);
  c6_w_o_out1(61) <= to_signed(16#2742#, 16);
  c6_w_o_out1(62) <= to_signed(-16#0DC4#, 16);
  c6_w_o_out1(63) <= to_signed(-16#2CA4#, 16);
  c6_w_o_out1(64) <= to_signed(-16#3E32#, 16);
  c6_w_o_out1(65) <= to_signed(16#05FD#, 16);
  c6_w_o_out1(66) <= to_signed(-16#15DC#, 16);
  c6_w_o_out1(67) <= to_signed(-16#2DE5#, 16);
  c6_w_o_out1(68) <= to_signed(16#01A0#, 16);
  c6_w_o_out1(69) <= to_signed(-16#0E1B#, 16);
  c6_w_o_out1(70) <= to_signed(16#08F2#, 16);
  c6_w_o_out1(71) <= to_signed(-16#4299#, 16);
  c6_w_o_out1(72) <= to_signed(-16#1FEE#, 16);
  c6_w_o_out1(73) <= to_signed(-16#3D96#, 16);
  c6_w_o_out1(74) <= to_signed(-16#2C14#, 16);
  c6_w_o_out1(75) <= to_signed(-16#17FF#, 16);
  c6_w_o_out1(76) <= to_signed(-16#38A8#, 16);
  c6_w_o_out1(77) <= to_signed(-16#0F15#, 16);
  c6_w_o_out1(78) <= to_signed(16#00E0#, 16);
  c6_w_o_out1(79) <= to_signed(-16#04EC#, 16);
  c6_w_o_out1(80) <= to_signed(16#048E#, 16);
  c6_w_o_out1(81) <= to_signed(16#1E52#, 16);
  c6_w_o_out1(82) <= to_signed(16#3535#, 16);
  c6_w_o_out1(83) <= to_signed(16#101D#, 16);
  c6_w_o_out1(84) <= to_signed(16#294B#, 16);
  c6_w_o_out1(85) <= to_signed(16#1193#, 16);
  c6_w_o_out1(86) <= to_signed(16#1250#, 16);
  c6_w_o_out1(87) <= to_signed(-16#0092#, 16);
  c6_w_o_out1(88) <= to_signed(16#24D9#, 16);
  c6_w_o_out1(89) <= to_signed(16#0F31#, 16);
  c6_w_o_out1(90) <= to_signed(16#29FE#, 16);
  c6_w_o_out1(91) <= to_signed(16#17B9#, 16);
  c6_w_o_out1(92) <= to_signed(16#247D#, 16);
  c6_w_o_out1(93) <= to_signed(-16#0FC1#, 16);
  c6_w_o_out1(94) <= to_signed(-16#1500#, 16);
  c6_w_o_out1(95) <= to_signed(16#0E05#, 16);
  c6_w_o_out1(96) <= to_signed(16#10EF#, 16);
  c6_w_o_out1(97) <= to_signed(-16#0E1F#, 16);
  c6_w_o_out1(98) <= to_signed(16#1DE2#, 16);
  c6_w_o_out1(99) <= to_signed(-16#05F4#, 16);
  c6_w_o_out1(100) <= to_signed(-16#1698#, 16);
  c6_w_o_out1(101) <= to_signed(16#4A85#, 16);
  c6_w_o_out1(102) <= to_signed(16#03F9#, 16);
  c6_w_o_out1(103) <= to_signed(16#0B83#, 16);
  c6_w_o_out1(104) <= to_signed(16#38E9#, 16);
  c6_w_o_out1(105) <= to_signed(16#282A#, 16);
  c6_w_o_out1(106) <= to_signed(16#1FFC#, 16);
  c6_w_o_out1(107) <= to_signed(16#3277#, 16);
  c6_w_o_out1(108) <= to_signed(16#22DA#, 16);
  c6_w_o_out1(109) <= to_signed(16#327F#, 16);

  w_o_out1_gen1: FOR d1 IN 0 TO 10 GENERATE
    w_o_out1_gen: FOR d0 IN 0 TO 9 GENERATE
      w_o_out1(d0, d1) <= c6_w_o_out1(d0 + (d1 * 10));
    END GENERATE;
  END GENERATE;

  s_gen1: FOR d1 IN 0 TO 10 GENERATE
    s_gen: FOR d0 IN 0 TO 9 GENERATE
      s(d0 + (d1 * 10)) <= w_o_out1(d0, d1);
    END GENERATE;
  END GENERATE;
